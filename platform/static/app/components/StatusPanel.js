...
import { goMemory, goTodos, refreshCurrent } from '../main.js';
      ...
      <div class="panel-head">
        ...
        <div class="status-head-right">
          <div class="memory-entry-actions">
            <button onClick=${() => goTodos(detail.name)}>Todos</button>
            <button onClick=${() => goMemory(detail.name, 'episodes')}>Episodes</button>
            <button onClick=${() => goMemory(detail.name, 'knowledge')}>Knowledge</button>
          </div>
